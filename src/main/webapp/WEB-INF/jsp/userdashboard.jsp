...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/userdashboard.css"> <!-- CSS file link -->
</head>
<body>
	...
	<div style="margin-top: 100px">
	    <h1 style='margin-bottom:25px'>Welcome to User Dashboard</h1>
	    <center><p id="error" style="color:red">${error}</p></center>
	    
	    <center>
	    <img style="width:90%;height:70vh;object-fit: contain;" alt="" src="https://cloudfront-us-east-1.images.arcpublishing.com/tronc/YK3FYIX3FFEMVC2LSVMXSYADTY.jpg">
	    </center>
